...
public class TransactionController {
    ...
    @Operation(summary = "Nạp tiền (Deposit)", description = "Nạp một số tiền vào tài khoản chỉ định")
    @PostMapping("/deposit")
    ...
    @Operation(summary = "Rút tiền (Withdraw)", description = "Rút tiền từ tài khoản kèm xác thực mã PIN")
    ...
    @Operation(summary = "Chuyển khoản (Transfer)", description = "Chuyển tiền từ tài khoản nguồn sang tài khoản đích")
    @PostMapping("/transfer")
    public ResponseEntity<ApiResponseDto<TransactionResponseDto>> transfer(@Valid @RequestBody TransferRequestDto request) {
