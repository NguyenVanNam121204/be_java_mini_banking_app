...
public class UserEntityMapper {
    ...
    public User toDomain(UserEntity entity) {
        ...
        // Set physical details from entity
        user.setPinFailedAttempts(entity.getPinFailedAttempts());
        user.setPinLockedUntil(entity.getPinLockedUntil());
        ...
        if (entity.getRoles() != null) {
            entity.getRoles().forEach(roleEntity -> 
                user.addRole(roleEntityMapper.toDomain(roleEntity))
            );
        }
